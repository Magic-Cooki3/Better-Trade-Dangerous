...
stations = {
    # Some legacy/invalid entries from prices files that do not map to tradeable markets
    # Mark them as deleted so cache import skips them cleanly.
    "COL 285 SECTOR OC-R B19-5/ORBITAL CONSTRUCTION SITE: ROBBINS' PRIDE": DELETED,
}
